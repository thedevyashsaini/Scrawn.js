 ...
 */
export type ServiceMethodNames<S extends ServiceType> = keyof S["methods"] &
  string;
 ...
 */
export type MessageTypeToMessage<T> =
  T extends MessageType<infer M> ? M : never;
 ...
 */
export type MethodsOfKind<S extends ServiceType, K extends MethodKind> = {
 ...
 */
export type ClientStreamingMethodNames<S extends ServiceType> = MethodsOfKind<
  S,
  "client_streaming"
>;
 ...
 */
export type ServerStreamingMethodNames<S extends ServiceType> = MethodsOfKind<
  S,
  "server_streaming"
>;
 ...
 */
export type BidiStreamingMethodNames<S extends ServiceType> = MethodsOfKind<
  S,
  "bidi_streaming"
>;
